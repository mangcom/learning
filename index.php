...
<head>
    ...
    <title>คลังระบบแผนการจัดการเรียนรู้ฐานสมรรถนะ ครูพรชัย ไอทีบางนา</title>
...
<body style="background-color: #f8fafc;">
    ...
    <div class="container" style="max-width: 1200px; margin: 40px auto; padding: 0 15px;">
        ...
        <div class="courses-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(360px, 1fr)); gap: 30px;">
            ...
            <div class="course-main-card" style="background: #fff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 30px; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.05); display: flex; flex-direction: column; justify-content: space-between;">
                <div>
                    <span style="background: #f5f3ff; color: #4f46e5; font-weight: 700; font-size: 0.8rem; padding: 4px 12px; border-radius: 20px;">รหัสวิชา 21901-2012</span>
                    <h4 style="margin: 15px 0 10px 0; color: #0f172a; font-size: 1.3rem; font-weight: 700;">การพัฒนาระบบร่วมกันด้วยแพลตฟอร์ม</h4>
                    <p style="font-size: 0.9rem; color: #475569; line-height: 1.6; margin: 0 0 20px 0;">มุ่งเน้นการใช้งานระบบควบคุมเวอร์ชัน (Git) การจัดการกิ่งโค้ด (Branching Flow) และกระบวนการ Code Review ผ่าน Pull Request ยกระดับการพัฒนาเป็นทีมร่วมกับบอร์ดคัมบัง, Docker Container และท่อ CI/CD อัตโนมัติ</p>
                </div>
                <a href="git/index.php" style="display: block; text-align: center; background: #4f46e5; color: #fff; text-decoration: none; padding: 12px; border-radius: 6px; font-weight: 600; transition: background 0.2s;">เข้าสู่บทเรียนรายวิชา ➔</a>
            </div>
