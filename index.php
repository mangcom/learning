...
<head>
    ...
    <title>คลังระบบแผนการจัดการเรียนรู้ฐานสมรรถนะ</title>
...
<body style="background-color: #f8fafc;">
    ...
    <div class="container" style="max-width: 1200px; margin: 40px auto; padding: 0 15px;">
        ...
        <div class="courses-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(450px, 1fr)); gap: 30px;">
            ...
            <div class="course-main-card" style="background: #fff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 30px; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.05); display: flex; flex-direction: column; justify-content: space-between;">
                <div>
                    ...
                    <h4 style="margin: 15px 0 10px 0; color: #0f172a; font-size: 1.4rem; font-weight: 700;">ระบบปฏิบัติการเครื่องแม่ข่าย</h4>
                    <p style="font-size: 0.95rem; color: #475569; line-height: 1.6; margin: 0 0 20px 0;">เจาะลึกโครงสร้างพื้นฐานระบบไอทีผ่านแกนหลัก Ubuntu Server เรียนรู้งาน CLI, การจัดการสิทธิ์, ระบบไฟร์วอลล์, บริการ DNS, DHCP, Web Server, Container Docker และการแก้ปัญหาเชิงระบบ</p>
                </div>
            ...
            <div class="course-main-card" style="background: #fff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 30px; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.05); display: flex; flex-direction: column; justify-content: space-between;">
                <div>
                    ...
                    <h4 style="margin: 15px 0 10px 0; color: #0f172a; font-size: 1.4rem; font-weight: 700;">การพัฒนาซอฟต์แวร์ด้วยเทคโนโลยี Back-End</h4>
                    <p style="font-size: 0.95rem; color: #475569; line-height: 1.6; margin: 0 0 20px 0;">ศึกษาโครงสร้างสถาปัตยกรรมแบบไคลเอนต์-เซิร์ฟเวอร์ การเขียนโปรแกรมฝั่งเซิร์ฟเวอร์ด้วยภาษาต่างๆ ระบบจัดการฐานข้อมูลและการทดสอบซอฟต์แวร์ตามมาตรฐานสากล</p>
                </div>
