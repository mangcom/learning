            ...
            <div class="units-column">
                ...
                <div class="unit-grid-layout" style="display: flex; flex-direction: column; gap: 15px;">
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit1.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit2.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit3.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit4.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit5.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit6.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit7.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit8.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit9.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit10.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit11.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit12.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit13.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="unit14.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px;">ดูบทเรียน ➔</a>
                    </div>
                    ...
                    <div class="unit-card-horizontal" style="background:#fff; border:1px solid #e2e8f0; padding:20px; border-radius:10px; display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <a href="final-project.php" target="_blank" class="btn-enter-unit" style="width:auto; white-space:nowrap; margin-left:20px; background-color:#10b981; border-color:#059669;">ส่งโครงงาน ➔</a>
                    </div>
